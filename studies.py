...
neutrons_thermalized = 0
neutrons_thermalized_collisions = 0

for i in range(num_simulations):
    result, positions, angles, energies, collisions = simulate(initial_position, initial_velocity,
                                                               ENERGY_ANALYSED_COLLISIONS=8)
    ...
    if result == "THERMALIZED":
        ...
        neutrons_thermalized = neutrons_thermalized + 1
        neutrons_thermalized_collisions = neutrons_thermalized_collisions + collisions
...
print("average collisions: ", (neutrons_thermalized_collisions / neutrons_thermalized))
...
plt.plot(range(1, ENERGY_ANALYSED_COLLISIONS + 1), average_energy_per_collision, marker='o', linestyle='-',
         color='blue', label='Simulated Average Energy')
plt.plot(range(1, ENERGY_ANALYSED_COLLISIONS + 1), theoretical_energy_per_collision, marker='x', linestyle='--',
         color='red', label='Theoretical Energy')
plt.xlabel('Collision Number')
plt.ylabel('Energy (MeV)')
